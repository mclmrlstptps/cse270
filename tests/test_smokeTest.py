...
class TestSmokeTest():
  ...
  def test_joinPage(self):
    ...
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.NAME, "lname")))
    self.driver.find_element(By.NAME, "bizname").click()
    WebDriverWait(self.driver, 30).until(expected_conditions.presence_of_element_located((By.NAME, "bizname")))
